...
- [ ] **T02: Extract the 912-line message dispatch switch into message-dispatch.ts** `est:1h`
...
- [ ] **T03: Extract polling.ts and html-generator.ts, verify ≤500 LOC target** `est:45m`
