...
- [x] **S04: Accessibility — ARIA & keyboard nav** `risk:medium` `depends:[]`
...
- [x] **S05: index.ts decomposition** `risk:medium` `depends:[S01,S02,S03,S04]`
...
- [x] **S06: Integration verification & polish** `risk:low` `depends:[S05]`
